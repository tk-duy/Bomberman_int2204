...
public class PathFinding {
     ...
     * @param allowDiagonals Pass true if you want 8 directional pathfinding, false for 4 directional
     * @return
     */
    ...
    private static List<Node> findPathNodes(Grid grid, Vector2D startPos, Vector2D targetPos, boolean allowDiagonals) {
        Node startNode = grid.nodes[startPos.getY()][startPos.getX()];
        Node targetNode = grid.nodes[targetPos.getY()][targetPos.getX()];
