...
//	public static Sprite wall = new Sprite(DEFAULT_SIZE, 5, 0, SpriteSheet.tiles, 16, 16);
	...
	/** player animation. */
	public static Image[] player_go_left_animation = new Image[] {
			player_left.getFxImage(),
	        player_left_1.getFxImage(),
	        player_left_2.getFxImage()
	};
	public static Image[] player_go_right_animation = new Image[] {
			player_right.getFxImage(),
			player_right_1.getFxImage(),
			player_right_2.getFxImage()
	};
	public static Image[]  player_go_up_animation = new Image[] {
			player_up.getFxImage(),
			player_up_1.getFxImage(),
			player_up_2.getFxImage()
	};
	public static Image[] player_go_down_animation = new Image[] {
			player_down.getFxImage(),
			player_down_1.getFxImage(),
			player_down_2.getFxImage()
	};
	public static Image[] player_death_animation = new Image[] {
			player_dead1.getFxImage(),
			player_dead2.getFxImage(),
			player_dead3.getFxImage()
	};

	/** Bomb animation. */
	public static Image[] bomb_animation = new Image[] {
			bomb.getFxImage(),
			bomb_1.getFxImage(),
			bomb_2.getFxImage()
	};
	...
	/** Explosion animation. */
	public static Image[] explosion_horizontal_animation = new Image[] {
			explosion_horizontal.getFxImage(),
			explosion_horizontal1.getFxImage(),
			explosion_horizontal2.getFxImage()
	};
	public static Image[] explosion_horizontal_right_animation = new Image[] {
			explosion_horizontal_right_last.getFxImage(),
			explosion_horizontal_right_last1.getFxImage(),
			explosion_horizontal_right_last2.getFxImage()
	};
	public static Image[] explosion_horizontal_left_animation = new Image[] {
			explosion_horizontal_left_last.getFxImage(),
			explosion_horizontal_left_last1.getFxImage(),
			explosion_horizontal_left_last2.getFxImage()
	};
	public static Image[] explosion_vertical_animation = new Image[] {
			explosion_vertical.getFxImage(),
			explosion_vertical1.getFxImage(),
			explosion_vertical2.getFxImage()
	};
	public static Image[] explosion_vertical_top_animation = new Image[] {
			explosion_vertical_top_last.getFxImage(),
			explosion_vertical_top_last1.getFxImage(),
			explosion_vertical_top_last2.getFxImage()
	};
	public static Image[] explosion_vertical_down_animation = new Image[] {
			explosion_vertical_down_last.getFxImage(),
			explosion_vertical_down_last1.getFxImage(),
			explosion_vertical_down_last2.getFxImage()
	};
	public static Image[] explosion_center_animation = new Image[] {
			bomb_exploded.getFxImage(),
			bomb_exploded1.getFxImage(),
			bomb_exploded2.getFxImage()
	};

	/** brick exploded animation. */
	public static Image[] brick_exploded_animation = new Image[] {
			brick_exploded.getFxImage(),
			brick_exploded1.getFxImage(),
			brick_exploded2.getFxImage()
	};

	/** ballom animation. */
	public static Image[] ballom_move_forward_animation = new Image[] {
			balloon_right1.getFxImage(),
			balloon_right2.getFxImage(),
			balloon_right3.getFxImage()
	};
	public static Image[] ballom_move_backward_animation = new Image[] {
			balloon_left1.getFxImage(),
			balloon_left2.getFxImage(),
			balloon_left3.getFxImage()
	};
	public static Image[] ballom_death_animation = new Image[] {
			balloon_dead.getFxImage(),
			mob_dead1.getFxImage(),
			mob_dead2.getFxImage(),
			mob_dead3.getFxImage()
	};

	/** Oneal animation. */
	public static Image[] oneal_move_forward_animation = new Image[] {
			oneal_right1.getFxImage(),
			oneal_right2.getFxImage(),
			oneal_right3.getFxImage()
	};
	public static Image[] oneal_move_backward_animation = new Image[] {
			oneal_left1.getFxImage(),
			oneal_left2.getFxImage(),
			oneal_left3.getFxImage()
	};
	public static Image[] oneal_death_animation = new Image[] {
			oneal_dead.getFxImage(),
			mob_dead1.getFxImage(),
			mob_dead2.getFxImage(),
			mob_dead3.getFxImage()
	};
	...
	/** Kondoria animation. */
	public static Image[] kondoria_move_forward_animation = new Image[] {
			kondoria_right1.getFxImage(),
			kondoria_right2.getFxImage(),
			kondoria_right3.getFxImage()
	};
	public static Image[] kondoria_move_backward_animation = new Image[] {
			kondoria_left1.getFxImage(),
			kondoria_left2.getFxImage(),
			kondoria_left3.getFxImage()
	};
	public static Image[] kondoria_death_animation = new Image[] {
			kondoria_dead.getFxImage(),
			mob_dead1.getFxImage(),
			mob_dead2.getFxImage(),
			mob_dead3.getFxImage()
	};
	...
	public static Image getImg(Image img) {
		return resample(img, 2);
	}
